...
const PAGES_URL = 'https://genilsuarez.github.io/agentstudy/';
const REPO = 'genilsuarez/agentstudy';
...
async function main() {
  const start = Date.now();
  console.log(`\n${colors.bright}${colors.cyan}📚 AgentStudy — deploy${colors.reset}\n`);
